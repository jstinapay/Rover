...
$stmt_categories->bind_param("i", $rover_id);
...
$sql_payment = "SELECT payment_method_id, payment_method_name
                FROM payment_method
                WHERE rover_id = ?";
$stmt_payment = $conn->prepare($sql_payment);
$stmt_payment->bind_param("i", $rover_id);
$stmt_payment->execute();
$result_payment = $stmt_payment->get_result();
$payment_methods = $result_payment->fetch_all(MYSQLI_ASSOC);
$stmt_payment->close();
...
<body>
    ...
    <main>
        <section class="createTrip-section">
            ...
            <form action="edit_expense.php?trip_id=<?php echo $trip_id; ?>" method="POST">
