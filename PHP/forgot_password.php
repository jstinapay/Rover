...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Check if there's an account with BOTH the email AND phone number
    ...
    if ($result_rover) {
        ...
        $error_message = "No account found with both the provided email and phone number. Both must match the same account.";
    }
}
?>
...
<head>
    ...
    <title>Change Password - Rover</title>
...
<main>
    <section class="login-section">
        ...
        <p>Enter both your email and phone number to verify your account</p>

        <?php if ($error_message): ?>
            <div class="error-message" style="color: red; margin-bottom: 15px; padding: 10px; background-color: #ffe6e6; border-radius: 5px;">
                <?php echo htmlspecialchars($error_message); ?>
            </div>
        <?php endif; ?>

        <?php if ($success_message): ?>
            <div class="success-message" style="color: green; margin-bottom: 15px; padding: 10px; background-color: #e6ffe6; border-radius: 5px;">
