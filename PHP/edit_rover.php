...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql_update = 'UPDATE rover 
                   SET first_name = ?, last_name = ?, email = ?, phone_number = ?, currency_code = ?
                   WHERE rover_id = ?';
    $stmt = $conn->prepare($sql_update);
    $stmt->bind_param('sssssi', $first_name, $last_name, $email, $phone_number, $currency_code, $rover_id);
    if ($stmt->execute()) {
    ...
    $sql = 'SELECT first_name, last_name, email, phone_number, currency_code
            FROM rover 
            WHERE rover_id = ?';
...
<body>
    ...
    <main>
        <section class="createTrip-section">
            ...
            <form action="edit_rover.php?rover_id=<?php echo $rover_id; ?>" method="POST">

                <label for="first_name">First Name</label>
                <input type="text" id="first_name" name="first_name"
                    value="<?php echo htmlspecialchars($rover['first_name']); ?>" required>
                ...
                <input type="email" id="email" name="email"
                    value="<?php echo htmlspecialchars($rover['email']); ?>" required>

            <label for="currency_code">Currency</label>
            <select name="currency_code" id="currency_code" required>">
                <option value="<?php echo htmlspecialchars($rover['currency_code'])?>"><?php echo htmlspecialchars($rover['currency_code']); ?></option>
